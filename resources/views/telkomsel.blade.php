    ...
    <div class="row g-4">
      ...
      <div class="col-md-4">
        <div class="section-box text-center">
          <img src="{{ asset('image/telkomsel.jpg')}}" alt="TELKOMSEL" class="img-fluid rounded shadow mb-3">
          <h3 class="fw-bold">TELKOMSEL</h3>
          <p class="text-white">Isi pulsa TELKOMSEL dengan cepat, mudah, dan aman.</p>
          <hr>
