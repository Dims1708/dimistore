    ...
    <div class="row g-4">
      ...
      <div class="col-md-4">
        <div class="section-box text-center">
          <img src="{{ asset('image/byu.jpg')}}" alt="by.U" class="img-fluid rounded shadow mb-3">
          <h3 class="fw-bold">by.U</h3></h3>
          <p class="text-white">Isi pulsa by.U dengan cepat, mudah, dan aman.</p>
          <hr>
          <h5 class="fw-bold">Cara Top Up:</h5>
          <ol class="text-start">
            <li>Masukkan Nomor by.U</li>
