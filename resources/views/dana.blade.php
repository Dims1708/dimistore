    ...
    <div class="row g-4">
      ...
      <div class="col-md-4">
        <div class="section-box text-center">
          <img src="{{ asset('image/dana.jpg')}}" alt="DANA" class="img-fluid rounded shadow mb-3">
          <h3 class="fw-bold">DANA</h3>
          <p class="text-white">Isi cash DANA dengan cepat, mudah, dan aman.</p>
          <hr>
          <h5 class="fw-bold">Cara Top Up:</h5>
          <ol class="text-start">
            <li>Masukkan Nomor DANA</li>
