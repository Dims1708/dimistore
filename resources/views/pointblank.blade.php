    ...
    <div class="row g-4">
      ...
      <div class="col-md-4">
        <div class="section-box text-center">
          <img src="{{ asset('image/pb.png')}}" alt="Point Blank" class="img-fluid rounded shadow mb-3">
          <h3 class="fw-bold">Mobile Legends</h3>
          <p class="text-white">Top up diamond Mobile Legends dengan cepat, mudah, dan aman.</p>
          <hr>
        ...
        <div class="section-box">
          ...
          <form>
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="userid" placeholder="Contoh: dimistore" required>
            </div>
          </form>
        </div>
          ...
          <div class="row g-3">
            <div class="col-md-3">
              <div class="produk-card">
                <div class="produk-title">1.200 PB Cash</div>
                <div class="produk-price">IDR 9.600</div>
              </div>
            </div>
            <div class="col-md-3">
              <div class="produk-card">
                <div class="produk-title">2.400 PB Cash</div>
                <div class="produk-price">IDR 19.200</div>
              </div>
            </div>
            <div class="col-md-3">
              <div class="produk-card">
                <div class="produk-title">6.000 PB Cash</div>
                <div class="produk-price">IDR 47.500</div>
              </div>
            </div>
            <div class="col-md-3">
              <div class="produk-card">
                <div class="produk-title">12.000 PB Cash</div>
                <div class="produk-price">IDR 94.000</div>
              </div>
            </div>
            <div class="col-md-3">
              <div class="produk-card">
                <div class="produk-title">24.000 PB Cash</div>
                <div class="produk-price">IDR 190.000</div>
              </div>
            </div>
          </div>
        </div>
