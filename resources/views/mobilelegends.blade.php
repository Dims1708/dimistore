    ...
    <div class="row g-4">
      ...
      <div class="col-md-4">
        <div class="section-box text-center">
          <img src="{{ asset('image/mobilelegends.jpg')}}" alt="Mobile Legends" class="img-fluid rounded shadow mb-3">
        ...
        <div class="section-box">
          ...
          <form>
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="zoneid" placeholder="Contoh: 1234" required>
            </div>
          </form>
        </div>
          ...
          <div class="row g-3">
            <div class="col-md-3">
              <div class="produk-card">
                <div class="produk-title">86 Diamonds</div>
                <div class="produk-price">IDR 20.000</div>
              </div>
            </div>
            <div class="col-md-3">
              <div class="produk-card">
                <div class="produk-title">172 Diamonds</div>
                <div class="produk-price">IDR 40.000</div>
              </div>
            </div>
            <div class="col-md-3">
              <div class="produk-card">
                <div class="produk-title">257 Diamonds</div>
                <div class="produk-price">IDR 60.000</div>
              </div>
            </div>
            <div class="col-md-3">
              <div class="produk-card">
