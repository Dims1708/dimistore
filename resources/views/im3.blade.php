    ...
    <div class="row g-4">
      ...
      <div class="col-md-4">
        <div class="section-box text-center">
          <img src="{{ asset('image/im3.jpg')}}" alt="IM3" class="img-fluid rounded shadow mb-3">
          <h3 class="fw-bold">IM3</h3>
          <p class="text-white">Isi pulsa IM3 dengan cepat, mudah, dan aman.</p>
          <hr>
          <h5 class="fw-bold">Cara Top Up:</h5>
          <ol class="text-start">
            <li>Masukkan Nomor IM3</li>
