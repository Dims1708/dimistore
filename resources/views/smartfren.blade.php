    ...
    <div class="row g-4">
      ...
      <div class="col-md-4">
        <div class="section-box text-center">
          <img src="{{ asset('image/smartfren.jpg')}}" alt="SMARTFREN" class="img-fluid rounded shadow mb-3">
          <h3 class="fw-bold">SMARTFREN</h3>
          <p class="text-white">Isi pulsa SMARTFREN dengan cepat, mudah, dan aman.</p>
          <hr>
          <h5 class="fw-bold">Cara Top Up:</h5>
          <ol class="text-start">
            <li>Masukkan Nomor SMARTFREN</li>
      ...
      <div class="col-md-8">
        <div class="section-box">
          ...
          <form>
            <div class="mb-3">
              <label for="userid" class="form-label">Nomor Tujuan</label>
              <input type="text" class="form-control" id="nomortelepon" placeholder="081234567891" required>
            </div>
          </form>
        </div>
          ...
          <div class="row g-3">
            <div class="col-md-3">
              <div class="produk-card">
                <div class="produk-title">5.000</div>
                <div class="produk-price">IDR 5.900</div>
              </div>
            </div>
            <div class="col-md-3">
              <div class="produk-card">
                <div class="produk-title">10.000</div>
                <div class="produk-price">IDR 10.900</div>
              </div>
            </div>
            <div class="col-md-3">
              <div class="produk-card">
                <div class="produk-title">15.000</div>
                <div class="produk-price">IDR 15.900</div>
              </div>
            </div>
            <div class="col-md-3">
              <div class="produk-card">
                <div class="produk-title">20.000</div>
                <div class="produk-price">IDR 20.900</div>
              </div>
            </div>
            <div class="col-md-3">
              <div class="produk-card">
                <div class="produk-title">25.000</div>
                <div class="produk-price">IDR 25.900</div>
              </div>
            </div>
            <div class="col-md-3">
              <div class="produk-card">
                <div class="produk-title">30.000</div>
                <div class="produk-price">IDR 30.900</div>
              </div>
            </div>
            <div class="col-md-3">
              <div class="produk-card">
                <div class="produk-title">35.000</div>
                <div class="produk-price">IDR 35.900</div>
              </div>
            </div>
            <div class="col-md-3">
              <div class="produk-card">
                <div class="produk-title">40.000</div>
                <div class="produk-price">IDR 40.900</div>
              </div>
            </div>
            <div class="col-md-3">
              <div class="produk-card">
                <div class="produk-title">45.000</div>
                <div class="produk-price">IDR 45.900</div>
              </div>
            </div>
            <div class="col-md-3">
              <div class="produk-card">
                <div class="produk-title">50000</div>
                <div class="produk-price">IDR 50.900</div>
              </div>
            </div>
            <div class="col-md-3">
              <div class="produk-card">
                <div class="produk-title">55.000</div>
                <div class="produk-price">IDR 55.900</div>
              </div>
            </div>
            <div class="col-md-3">
              <div class="produk-card">
                <div class="produk-title">60.000</div>
                <div class="produk-price">IDR 60.900</div>
              </div>
            </div>
            <div class="col-md-3">
              <div class="produk-card">
                <div class="produk-title">65.000</div>
                <div class="produk-price">IDR 65.900</div>
              </div>
            </div>
            <div class="col-md-3">
              <div class="produk-card">
                <div class="produk-title">70.000</div>
                <div class="produk-price">IDR 70.900</div>
              </div>
            </div>
            <div class="col-md-3">
              <div class="produk-card">
                <div class="produk-title">75.000</div>
                <div class="produk-price">IDR 75.900</div>
              </div>
            </div>
            <div class="col-md-3">
              <div class="produk-card">
                <div class="produk-title">80.000</div>
                <div class="produk-price">IDR 80.900</div>
              </div>
            </div>
            <div class="col-md-3">
              <div class="produk-card">
                <div class="produk-title">85.000</div>
                <div class="produk-price">IDR 85.900</div>
              </div>
            </div>
            <div class="col-md-3">
              <div class="produk-card">
                <div class="produk-title">90.000</div>
                <div class="produk-price">IDR 90.900</div>
              </div>
            </div>
            <div class="col-md-3">
              <div class="produk-card">
                <div class="produk-title">95.000</div>
                <div class="produk-price">IDR 95.900</div>
              </div>
            </div>
            <div class="col-md-3">
              <div class="produk-card">
                <div class="produk-title">100.000</div>
                <div class="produk-price">IDR 100.900</div>
              </div>
            </div>
            <div class="col-md-3">
              <div class="produk-card">
                <div class="produk-title">125.000</div>
                <div class="produk-price">IDR 125.900</div>
              </div>
            </div>
            <div class="col-md-3">
              <div class="produk-card">
                <div class="produk-title">150.000</div>
                <div class="produk-price">IDR 150.900</div>
              </div>
            </div>
            <div class="col-md-3">
              <div class="produk-card">
                <div class="produk-title">200.000</div>
                <div class="produk-price">IDR 200.900</div>
              </div>
            </div>
          </div>
        </div>
