    ...
    <div class="row g-4">
      ...
      <div class="col-md-4">
        <div class="section-box text-center">
          <img src="{{ asset('image/gopay.jpg')}}" alt="GOPAY" class="img-fluid rounded shadow mb-3">
          <h3 class="fw-bold">GOPAY</h3>
          <p class="text-white">Isi cash GOPAY dengan cepat, mudah, dan aman.</p>
          <hr>
          <h5 class="fw-bold">Cara Top Up:</h5>
          <ol class="text-start">
            <li>Masukkan Nomor GOPAY</li>
